# [SOLVED] Fix-Git-Blame-To-Show-Original-File-After-File-Was-Already-C
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/fix-git-blame-to-show-original-file-after-file-was-already-c)
>
...
Use `git blame --porcelain` and then manually edit the output to show the original file name.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/fix-git-blame-to-show-original-file-after-file-was-already-c)**
